@extends('template')
@section('content')
    <h1 class="text-2xl font-bold">Create Meeting</h1>
    ...
    <form method="POST" action="{{ route('meetings.store') }}" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            ...
            <input type="number" id="project_id" name="project_id" class="mt-1 block w-full">
        </div>

        <div class="mb-4">
            <label for="meeting_date" class="block text-sm font-medium text-gray-700">Meeting Date</label>
            <input type="datetime-local" id="meeting_date" name="meeting_date" class="mt-1 block w-full">
        </div>

        <div class="mb-4">
            <label for="meeting_location" class="block text-sm font-medium text-gray-700">Meeting Location</label>
            <input type="text" id="meeting_location" name="meeting_location" class="mt-1 block w-full">
        </div>

        <div class="mb-4">
            <label for="meeting_agenda" class="block text-sm font-medium text-gray-700">Meeting Agenda</label>
            <textarea id="meeting_agenda" name="meeting_agenda" class="mt-1 block w-full"></textarea>
        </div>

        <div class="mb-4">
            <label for="meeting_agenda_en" class="block text-sm font-medium text-gray-700">Meeting Agenda (EN)</label>
            <textarea id="meeting_agenda_en" name="meeting_agenda_en" class="mt-1 block w-full"></textarea>
        </div>
